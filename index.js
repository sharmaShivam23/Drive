...
// // Update session configuration with dynamic secure and MongoDB store
// app.use(session({
//   secret: process.env.SESSION_SECRET || 'your-session-secret',
//   resave: false,
//   saveUninitialized: false,
//   store: MongoStore.create({
//     mongoUrl: process.env.URL, // Ensure this is set in .env
...
//     message: err.message,
//     code: err.code, // Log CSRF-specific error code
//     stack: err.stack,
//   });
//   res.status(err.status || 500).json({
//     success: false,
